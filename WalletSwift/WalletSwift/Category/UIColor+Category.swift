...
extension UIColor{
    ...
    /** 获取HexString颜色*/
    class func colorFromHex(hexString: String, alpha: CGFloat = 1) -> UIColor {
    ...
    /** 获取RGB颜色*/
    class func colorFromRGB(red: CGFloat, green: CGFloat, blue: CGFloat, alpha: CGFloat = 1) -> UIColor {
